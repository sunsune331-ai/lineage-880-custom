...
public class MonsterBook {
	public static final String[] _records = new String[] { "npc_id", "book_id", "book_step_first", "book_step_second",
			"book_step_third", "book_clear_num2", "tel_x", "tel_y", "tel_mapId", "week_difficulty",
			"week_success_count", "marteriaL" };
	...
	public void setMarterial(int i) {
		_marteriaL = i;
	}
