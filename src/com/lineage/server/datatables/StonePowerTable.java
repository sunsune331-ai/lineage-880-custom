...
public class StonePowerTable {  //src039
	...
	public final void load() {
		...
		try {
			...
			pstm = conn
					.prepareStatement("SELECT * FROM extra_stone_power ORDER BY id");
			...
			while (rs.next()) {
				...
				final L1StonePower l1StonePower = new L1StonePower(note, id,
						ac, hp, mp, hpr, mpr, str, con, dex, wis, cha, intel,
						sp, mr, hit_modifier, dmg_modifier, bow_hit_modifier,
		...
		_log.info("載入凹槽石頭種類: : " + _stoneList.size() + "(" + timer.get()
				+ "ms)");
	}
