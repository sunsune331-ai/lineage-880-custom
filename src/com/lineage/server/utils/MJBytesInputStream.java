...
public class MJBytesInputStream extends InputStream{
	...
	public String readS() throws IOException{
		return readS(CLIENT_LANGUAGE_CODE);
	}
	...
	public String readS(int length) throws IOException{
		return readS(CLIENT_LANGUAGE_CODE, length);
	}
	...
	public String readSForMultiBytes() throws IOException{
		...
		while(true){
			...
			if(d1 >= 0x7F || d2 >= 0x7F){
				...
				tmpB[0] = d2;
				tmpB[1] = d1;
				sb.append(new String(tmpB, 0, 2, CLIENT_LANGUAGE_CODE));
			}else{
				/** english and number. **/
				tmpB[0] = d1;
				sb.append(new String(tmpB, 0, 1, CLIENT_LANGUAGE_CODE));
			}
		}
		return sb.toString();
	}
