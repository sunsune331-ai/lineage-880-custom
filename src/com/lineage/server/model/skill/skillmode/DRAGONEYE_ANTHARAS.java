...
public class DRAGONEYE_ANTHARAS extends SkillMode {
	public int start(L1PcInstance srcpc, L1Character cha, L1Magic magic, int integer) throws Exception {
		int dmg = 0;
		if (!srcpc.hasSkillEffect(6684)) {
			// srcpc.addRegistStone(3); // 石化耐性
			srcpc.setSkillEffect(6684, integer * 1000);
			srcpc.add_dodge(1);
