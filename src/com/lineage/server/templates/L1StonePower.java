...
public class L1StonePower {  //src039
	...
	public L1StonePower(final String note, final int id, final int ac,
			final int hp, final int mp, final int hpr, final int mpr,
			final int str, final int con, final int dex, final int wis,
			final int cha, final int intel, final int sp, final int mr,
			final int hit_modifier, final int dmg_modifier,
