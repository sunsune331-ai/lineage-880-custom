...
import com.lineage.server.serverpackets.S_TelePortUi;
...
public class C_NPCTalk extends ClientBasePacket {
	...
	private static String[] action = new String[] { "T_talk island", "T_gludio", "T_orc", "T_woodbec",
			...
			"T_behemoth", "T_silveria", /* "T_pcbang", */ "D_talk island", "D_gludio", "D_elven", "D_training",
			"D_barlog", "D_dragon valley", "D_eva kingdom", "D_ivory tower", "D_yahee", "F_shelob", "F_orc forest",
			"F_ruin of death", "F_desert", "F_dragon valley", "F_halpas", "F_valakas", "F_jungle", "F_heine",
			"F_mirror", "F_elmor", "F_orenwall", "F_lindvior", "F_giant" };
		...
		try {
			...
			if (obj != null && pc != null) {
				...
				if (obj instanceof L1NpcInstance) {
					...
					//System.out.println("npcid:"+npc.getId()+",tempid:"+npc.getNpcId());
					// 具有執行項
					if (npc.TALK != null) {
				...
				if (obj instanceof L1NpcInstance) { // 轉生天賦
					final L1NpcInstance npc = (L1NpcInstance) obj;
					if (npc.getNpcId() == 4070088) {
