...
public class Create_Monster_Magic_Wand extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		// 送出封包(動作)
		pc.broadcastPacketAll(new S_DoActionGFX(pc.getId(), ActionCodes.ACTION_Wand));
		...
		if (isUse) {
			final int[] mobArray = { 45008, 45140, 45016, 45021, 45025, 45033, 45099, 45147, 45123, 45130, 45046, 45092,
