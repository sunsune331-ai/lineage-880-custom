	...
	public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
		try {
			...
			if (pc.hasSkillEffect(7008)) {
				pc.sendPackets(new S_ServerMessage("\\fV[地氣術]效果尚存:" + pc.getSkillEffectTimeSec(7008)));
				return;
			}
			...
			pc.setSkillEffect(7008, _time * 1000);
 ...
 * com.lineage.data.item_etcitem.skill.C3_EARTH_Item JD-Core Version: 0.6.2
 */