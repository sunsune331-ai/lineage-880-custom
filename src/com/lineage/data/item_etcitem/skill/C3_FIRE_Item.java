	...
	public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
		try {
			...
			if (pc.hasSkillEffect(7005)) {
				pc.sendPackets(new S_ServerMessage("\\fV[火轉術]效果尚存:" + pc.getSkillEffectTimeSec(7005)));
				return;
			}
			...
			pc.setSkillEffect(7005, _time * 1000);
 ...
 * com.lineage.data.item_etcitem.skill.C3_FIRE_Item JD-Core Version: 0.6.2
 */