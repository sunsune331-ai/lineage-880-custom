...
public class EnchantProtectB extends ItemExecutor {
	private static final Log _log = LogFactory.getLog(EnchantProtectB.class);

	public static ItemExecutor get() {
		return new EnchantProtectB();
	}
