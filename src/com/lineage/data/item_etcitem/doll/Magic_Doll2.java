 ...
 * 魔法娃娃
 */
public class Magic_Doll2 extends ItemExecutor {//src016
	...
	private void useMagicDoll(final L1PcInstance pc, final int itemId,
		...
		if (pc.getDoll2(itemObjectId) != null) {
			// 娃娃收回
			pc.getDoll2(itemObjectId).deleteDoll2();
			return;
		}
		...
		if (pc.getDolls2().size() >= ConfigAlt.MAX_DOLL_COUNT2) {
		...
		if (type != null) {
			...
			if (!iserror) {
				...
				L1DollInstance2 doll = new L1DollInstance2(template, pc, itemObjectId, type);// 召喚出娃娃
