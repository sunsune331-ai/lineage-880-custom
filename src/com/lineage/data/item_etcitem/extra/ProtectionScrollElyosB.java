 ...
 * @author terry0412
 */
public class ProtectionScrollElyosB extends ItemExecutor {
	 ...
	 *
	 */
	private ProtectionScrollElyosB() {
		// TODO Auto-generated constructor stub
	}
	

	public static ItemExecutor get() {
		return new ProtectionScrollElyosB();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc,
		...
		// 最高只能強化到 +20
		if (tgItem.getEnchantLevel() >= ConfigOther.ELYOS_ENCHANT) {
