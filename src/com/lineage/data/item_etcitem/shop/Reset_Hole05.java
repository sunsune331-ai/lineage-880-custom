...
public class Reset_Hole05 extends ItemExecutor {//src039

	private static Random _random = new Random();

	private Reset_Hole05() {

	}

	public static ItemExecutor get() {
		return new Reset_Hole05();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc,
		...
		if (power != null) {
			if ((tgItem.getItem().getType2() == 1 && power.get_hole_5() == 0)
					|| (tgItem.getItem().getType2() == 2 && power.get_hole_5() == 0)) {
			...
			if (50 >= chance) {
				...
				final int itemId = power.get_hole_5();
