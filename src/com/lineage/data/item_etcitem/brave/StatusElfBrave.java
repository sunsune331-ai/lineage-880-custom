	...
	public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
		...
		if (L1BuffUtil.stopPotion(pc))
			if (check(pc)) {
				...
				pc.sendPackets(new S_SkillBrave(pc.getId(), 3, _time));
				pc.broadcastPacketAll(new S_SkillBrave(pc.getId(), 3, 0));

				pc.setSkillEffect(1016, _time * 1000);
 ...
 * com.lineage.data.item_etcitem.brave.StatusElfBrave JD-Core Version: 0.6.2
 */