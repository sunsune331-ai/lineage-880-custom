...
public class NewOM_TeleportRune_Seal extends ItemExecutor {
	public static ItemExecutor get() {
		return new NewOM_TeleportRune_Seal();
	}
	...
	public void execute(int[] data, L1PcInstance pc, L1ItemInstance item) {
		...
		L1ItemInstance item1 = pc.getInventory().storeItem(itemId + 10, 1L);
		if (item1 != null) {
