...
/**
 * <font color=#00800>名人的對武器施法的卷軸(+10適用)</font><BR>
 *
 */
public class FantasyEnchantWeapon2 extends ItemExecutor {

	/**
	 *
	 */
	private FantasyEnchantWeapon2() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new FantasyEnchantWeapon2();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (tgItem.getEnchantLevel() != 10) {// 20161118
			pc.sendPackets(new S_ServerMessage("只能對+10的武器使用。"));
			return;
		}
		// 物品已追加值
		...
		if (isEnchant) {// 成功
//			ConfigRecord.recordToFiles("名人武卷強化記錄",
...
//							+ "(" + new Timestamp(System.currentTimeMillis()) + ")。");
			...
			if (tgItem.getproctect() == true) { // A級-如果裝備受到保護中往下執行
				...
				if (tgItem.getproctect() == false) {
					ConfigRecord.recordToFiles("名人武卷強化失敗記錄","IP" + "(" + pc.getNetConnection().getIp() + ")"//20180721文字修改
					        + "玩家" + ":【" + pc.getName() + "】" 
							+ "的" + "【+" + tgItem.getEnchantLevel() + " " 
					        + tgItem.getName() + "】- 強化失敗" 
