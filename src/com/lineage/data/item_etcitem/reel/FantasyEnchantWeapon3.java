...
/**
 * <font color=#00800>達人的對武器施法的卷軸(+11適用)</font><BR>
 *
 */
public class FantasyEnchantWeapon3 extends ItemExecutor {

	/**
	 *
	 */
	private FantasyEnchantWeapon3() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new FantasyEnchantWeapon3();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (tgItem.getEnchantLevel() != 11) {// 20161118
			pc.sendPackets(new S_ServerMessage("只能對+11的武器使用。"));
			return;
		}
		// 物品已追加值
		...
		if (isEnchant) {// 成功
//			ConfigRecord.recordToFiles("達人武卷強化記錄",
...
//							+ "(" + new Timestamp(System.currentTimeMillis()) + ")。");
			...
			if (tgItem.getproctect() == true) { // A級-如果裝備受到保護中往下執行
				...
				if (tgItem.getproctect() == false) {
					ConfigRecord.recordToFiles("達人武卷強化失敗記錄",//20180721文字修改
							"IP" + "(" + pc.getNetConnection().getIp() + ")" + "玩家" + ":【" + pc.getName() + "】" + "的"
