 ...
 * 魔化的黑帝斯斗篷強化卷軸<br>
 */
public class ScrollEnchantHades extends ItemExecutor {

	/**
	 *
	 */
	private ScrollEnchantHades() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new ScrollEnchantHades();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (isEnchant) {// 成功
			...
			// 記錄文件檔 by terry0412
			Timestamp timestamp = new Timestamp(System.currentTimeMillis());
			ConfigRecord.recordToFiles("強化防具紀錄","IP("
							+ pc.getNetConnection().getIp()
							+ ")玩家【"+ pc.getName()+ "】的【"+ tgItem.getRecordName(tgItem.getCount())
							+ ", (ObjId: " + item.getId()
