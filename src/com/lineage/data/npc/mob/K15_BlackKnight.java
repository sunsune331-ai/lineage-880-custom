				...
				if (pc.getQuest().isStart(KnightLv15_1.QUEST.get_id())) {
					if (pc.getInventory().checkItem(20005)) {
						if (_random.nextInt(100) < 40) {
							CreateNewItem.getQuestItem(pc, npc, 40540, 1L);
						}
					} else {
						if (pc.getInventory().checkItem(40608)) {
							return pc;
						}
						if (_random.nextInt(100) < 40) {
							CreateNewItem.getQuestItem(pc, npc, 40608, 1L);
						}
					}
				}
			}
 ...
 * com.lineage.data.npc.mob.K15_BlackKnight JD-Core Version: 0.6.2
 */