		...
		try {
			...
			if (pc != null) {
				...
				if (pc.getQuest().isStart(DarkElfLv45_1.QUEST.get_id())) {
					...
					if (pc.getQuest().get_step(DarkElfLv45_1.QUEST.get_id()) == 3) {
						CreateNewItem.getQuestItem(pc, npc, 40584, 1L);
						return pc;
					}
				}
			}
 ...
 * com.lineage.data.npc.mob.DE45_WickedYeti JD-Core Version: 0.6.2
 */